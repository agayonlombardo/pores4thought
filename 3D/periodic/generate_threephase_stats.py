...
#out_dir = 'output_circle_layer1_cpad3_crop_'+str(size)+'_'+str(size)
out_dir = 'test_fast'
os.makedirs(str(out_dir), exist_ok=True)

checkpoint = torch.load('mod_out/netG_epoch_32.pth', map_location=device)
