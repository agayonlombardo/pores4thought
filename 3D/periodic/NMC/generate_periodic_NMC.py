...
a.gayon-lombardo17@imperial.ac.uk
"""
...
alp = (size - 64)/16+1
out_dir = 'periodic_tests/github' # Name of output directory
os.makedirs(str(out_dir), exist_ok=True)

## Path for DCGANs
# Load the path of the trained weights of the Generator
state_dict = torch.load('mod_out/netG_epoch_50.pth')
